			...
			<div class="laypop_quick" style="width:105px; height:0px; position:absolute; z-index:100; margin:0 auto; top:30px" align="center">
				...
				<table border="1" frame="void" rules="rows" cellpadding="0" cellspacing="0">
					...
					<tr height="30">
						...
						<td align="right">
							<c:if test="${dust.getPm10_state().equals('bad')}"><font style="font-size:12px; color:#878787">측정불가</font></c:if>
						...
						<td>
							<c:if test="${dust.getPm10_state().equals('bad')}"></c:if>
					...
					<tr height="30">
						...
						<td align="right">
							<c:if test="${dust.getPm25_state().equals('bad')}"><font style="font-size:12px; color:#878787">측정불가</font></c:if>
						...
						<td>
							<c:if test="${dust.getPm25_state().equals('bad')}"></c:if>
					...
					<tr height="26">
						<td colspan ="3" align="right"><font style="font-size:11px">(14:00기준)</font></td>
					</tr>
				</table>
			</div>
		</div>
		<div style="width:105px; height:500px; margin:0 auto; margin-right:-120px; display:none">
