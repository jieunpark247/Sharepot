...
<form id="dropForm" name="dropForm" action="memberDropComplete.do" method="post">
   ...
   <font style="font-size:22px; color:#414141; font-weight:bold; color: #d55454">* 탈퇴 안내*</font><br><div style="margin-bottom:2px"></div>
   ...
   <table class="table_basic" cellpadding="0" cellspacing="0" style="margin-top:60px; margin-bottom:80px">
      <tr>
         <td align="center"><input id="dropMember" name="dropMember" type="button" value="확인" style="width:180px; height:70px; background-color:#d55454; border:0; boder-radius:0; font-size:24px; color:#ffffff; font-family:'나눔고딕'; cursor:pointer"></td>
         <td width="20"></td>
      </tr>
   </table>
