...
<script src="http://code.jquery.com/jquery-1.12.1.js"></script> 
        ...
        function isConfirm(rent_id,item_no) {
        var con_test = confirm("반납 처리 하시겠습닙까?.");
			if(con_test == true){
  			alert("반납 처리 되었습니다");
  			location.href = "managerReturn.do?flag=0&rent_id="+rent_id+"&item_no="+item_no;
        ...
        function isConfirmMi(rent_id,item_no) {
            var con_test = confirm("미납 처리 하시겠습닙까?.");
    			if(con_test == true){
      			alert("미납 처리 되었습니다");
      			location.href = "managerReturn.do?flag=1&rent_id="+rent_id+"&item_no="+item_no;
        ...
        function isConfirmMiFinal(rent_id,item_no) {
            var con_test = confirm("반납 처리 하시겠습닙까?.");
    			if(con_test == true){
      			alert("반납 처리 되었습니다");
      			location.href = "managerReturn.do?flag=2&rent_id="+rent_id+"&item_no="+item_no;
                                  ...
                                  <c:forEach var="managerReturnDTO" items="${list}">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>${managerReturnDTO.fee}</td>
                                                     <td><span class="label label-success" color:white><a href="#" onclick="isConfirmMi(${managerReturnDTO.rent_id},${managerReturnDTO.item_no})">미납</a> </span><span class="label label-success" color:white><a href="#" onclick="isConfirm(${managerReturnDTO.rent_id},${managerReturnDTO.item_no})">반납</a></span></td>
                            ...
                            <div class="col-md-12">
                                <div class="panel">
                                  ...
                                  <c:forEach var="managerMiDTO" items="${milist}">
                                                ...
                                                <td><span class="label label-success" color:white><a href="#" onclick="isConfirmMiFinal(${managerMiDTO.rent_id},${managerMiDTO.item_no})">반납</a> </td>
