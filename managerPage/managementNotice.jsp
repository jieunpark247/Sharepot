...
<jsp:include page="/managerPage/managerMenu.jsp"></jsp:include>
<!-- 상단메뉴바 -->
						...
						<div class="col-md-12">
							<div class="panel">
								...
								<div class="panel-body">
										...
										<tbody>
											...
											<c:forEach items="${mdtos}" var="mdto">
												<tr>
													...
													<td><a
														href="/Sharepot/managerPage/managementNoticeDetail.do?notice_no=${mdto.notice_no }">${mdto.title}</a></td>
													<td>${mdto.date }</td>
													<td>${mdto.hits }</td>
									...
									<a role="button" href="/Sharepot/managerPage/managementNoticeWrite.do?"
