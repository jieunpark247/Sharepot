					...
					<table class="table_basic" width="800" cellpadding="0"
						...
						<tr>
							...
							<td width="245" valign="top"
								style="background: url('images/main/seaFrchbar2.png'); background-size: 100%; height: 38px; background-repeat: no-repeat">
		...
		<div class="divWid">
			...
			<div
				...
				<div
					...
					<font
						style="font-size: 32px; color: #424242; font-weight: bold; margin-bottom: 40px">
						Q&A 문의내역 </font><br> <br> <font
				...
				<table class="content-table myQna" width="740"
					...
					<tr height="50" style="border: 1px solid black;">
						...
						<td id="table-td" width="404" align="left"
							style="padding-left: 15px; text-align: center;">${qnaDTO.title }</td>
						...
						<td id="table-td" width="109" style="text-align: center;"><fmt:formatDate
								value="${qnaDTO.date }" pattern="yyyy-MM-dd" /></td>
					</tr>
					<tr height="40" style="border: 1px solid black;">
						...
						<td colspan="3" id="table-td" width="404" align="left"
							style="padding-left: 15px; text-align: center;">${qnaDTO.member_id }</td>
					</tr>
					</tr>
					<tr height="40" style="border: 1px solid black;">
						<td colspan="1" id="table-td" width="100"
						...
						<td colspan="3" id="table-td" width="404" align="left"
							style="padding-left: 15px; text-align: center;">${qnaDTO.content }</td>
					</tr>
					<tr height="10"></tr>
				</table>
				<hr width=100%>
				<div class="text-right">
					<button type="button" class="btn btn-color btn-sm"
						onclick="location.href='managementQnA.do' ">
						</i>목록으로
					</button>
				</div>
							...
							<c:forEach var="qnaCommentlist" items="${qnaCommentlist}">
								...
								<tr height="30" style="border: 1px solid #ffffff;">
									<td colspan="4" style="text-align: center;"><font
										style="font-size: 21px; color: #424242; font-weight: bold; margin-bottom: 40px">답변</font></td>
								</tr>
								<tr height="10">
								<tr height="50" style="border: 1px solid black;">
									<td id="table-td" width="100"
									...
									<td id="table-td" width="109"
										...
										style="font-size: 15px; color: #151515; margin-bottom: 40px">등록일</font></td>
									<td id="table-td" width="109" style="text-align: center;"><fmt:formatDate
											value="${qnaCommentlist.date }" pattern="yyyy-MM-dd" /></td>
								</tr>
								<tr class="myQna" height="50" style="border: 1px solid black;">
									...
									<td colspan="3" id="table-td" width="808" align="left"
										style="padding-left: 15px; text-align: center;">${qnaCommentlist.content }
									</td>
...
<%-- 
						<c:if test="${answerCheck  eq  0}"> --%>
							<form action="/Sharepot/managerPage/MngQnAAnsAction.do" method="post">

								<input name="qna_no" type="hidden" readonly="readonly"
									value=${qnaDTO.qna_no }>
								답변 처리<br>
