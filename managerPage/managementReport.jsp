...
<%-- <jsp:include page="/Sharepot/managerPage/aboveMenuManager.jsp"></jsp:include> --%>
<%-- <jsp:include page="/Sharepot/managerPage/floatingBanner.jsp" /> --%>
...
<body hoe-navigation-type="vertical" hoe-nav-placement="left"
						...
						<div class="col-md-12">
							<div class="panel">
								<header class="panel-heading">
									<h2 class="panel-title">건의사항 게시판</h2>
								</header>
										...
										<tbody>
											...
											<c:forEach items="${reportlist}" var="reportlist">
												<tr>
													...
													<td>${reportlist.member_id }</td>
													<td><a href="managementReportDetail.do?report_no=${reportlist.report_no }">${reportlist.title }</a></td>
													<td>${reportlist.report_option }</td>
	...
	<!--end wrapper-->
        ...
        <!-- Datatables-->
        <script src="/Sharepot/managerPage/plugins/datatables/jquery.dataTables.min.js"></script>
        <script src="/Sharepot/managerPage/plugins/datatables/dataTables.responsive.min.js"></script>
        <script>
