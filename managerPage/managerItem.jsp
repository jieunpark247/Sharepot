                     ...
                     <div class="page-center-in">
                         <form action="managerItemInsert.do?pg=0" method="post" class="sign-box">
                             ...
                             <header class="sign-title">물품 사진</header>
                                 ...
                                 <input type="text" class="form-control" placeholder="물품 이름" name="item_name" required autofocus>
                             </div>
                                
                                <div class="form-group">
                                 <input type="text" class="form-control" placeholder="물품 사진" name="img" required>
                             </div>
                               
                                <div class="form-group">
                                 <input type="text" class="form-control" placeholder="물품 위치" name="location" required>
                             </div>
                           <div class="form-group">
                                 <input type="number" class="form-control" placeholder="물품 가격" name="cost" min="1" max="999999" required>
                             </div>
                                <div class="form-group">
                                 <input type="number" class="form-control" placeholder="물품 갯수" name="ea" min="1" max="1000" required>
                             </div>
                     ...
                     <div class="panel">
                        <div class="panel-body">
                           <div class="text-center">
                              <button style="background-color:#d55454;" type="button"  class="btn btn-danger btn-lg btn-block" data-toggle="modal" data-target="#myModal"><i class="ion-ios-compose-outline"></i> 새 물품 추가</button>
                           </div>
                           <hr>
