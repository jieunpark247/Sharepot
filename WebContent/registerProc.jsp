...
<div id="container" class="div container" align="center">
	<div class="divWid">
		...
		<div style="margin-top:40px" align="center">
			<font style="font-size:22px; color:#6bb546; font-weight:bold">* 회원가입 완료 *</font><br><div style="margin-bottom:2px"></div>
			...
			<input id="registerNext" name="registerNext" type="button" value="로그인하기" style="margin-top:85px; margin-bottom:80px; width:240px; height:75px; background-color:#6bb546; border:0; border-radius:7px; font-size:22px; color:#ffffff; font-family:'나눔고딕'; cursor:pointer">
		</div>
	</div>
