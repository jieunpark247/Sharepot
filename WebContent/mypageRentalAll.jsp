...
<body style="font-family: '나눔고딕'" onload="$('#log_user_id').focus()">
			 ...
			 <div align="center">
				...
				<tr height="26" align="center">
					...
					<a id = "listAll" class= "myList_sub" href=""> <font
							style="font-size: 14px; color: #0e7534" id="listColor">대여 내역</font>
					</a> 
					<a id= "offerList" class= "myList_sub" style="margin-left: 20px; cursor:pointer" > <font
							style="font-size: 14px; color: #000000" id="offerListColor">무료 제공 물품 내역</font>
					</a>  
					</td>
				</tr>
				</table>
	...
	<table class="content-table" width="740" border="1" frame="void"
		...
		<tr height="40" style="background-color: #f6f6f6">
			...
			<td id="table-td" class="table-line" width="150">반납일</td>
			<td id="table-td" class="table-line" width="120">반납 유형</td>
		</tr>
		...
		<c:choose>
			...
			<c:otherwise>
				...
				<tr>
					...
					<td align="center">
						<c:choose>
							<c:when test="${rent.return_date ==''}">
							-
							</c:when>
							<c:otherwise>
								<fmt:formatDate value="${rent.return_date }" pattern="yyyy-MM-dd" />
							</c:otherwise>
						</c:choose>
					</td>
					<td align="center">
