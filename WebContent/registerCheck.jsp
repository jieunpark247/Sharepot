...
<jsp:include page="regiCheckTxt/regiTxt1.txt" />
				</textarea>
			</div>
			...
			<div style="width:800px; margin-top:15px" align="center">
				...
				<div style="width:800px; margin-top:5px">
					<textarea style="width:500px; height:150px; resize:none; font-family:'나눔고딕'; overflow-x:hidden" readonly>
<jsp:include page="regiCheckTxt/regiTxt2.txt" />
					</textarea>
				</div>
				<table class="table_basic" width="800" cellpadding="0" cellspacing="0" style="margin-top:10px">
					<tr height="22">
			...
			<div style="width:800px; margin-top:15px" align="center">
				...
				<div style="width:800px; margin-top:5px">
					<textarea style="width:500px; height:150px; resize:none; font-family:'나눔고딕'; overflow-x:hidden" readonly>
<jsp:include page="regiCheckTxt/regiTxt3.txt" />
					</textarea>
				</div>
				<table class="table_basic" width="800" cellpadding="0" cellspacing="0" style="margin-top:10px">
					<tr height="40">
...
<jsp:include page="regiCheckTxt/regiTxt4.txt" />
		...
		<table class="table_basic" cellpadding="0" cellspacing="0" style="margin-top:40px; margin-bottom:80px">
			<tr>
				<td align="right"><input id="registerBnt" name="registerBnt" type="button" value="다음 단계로" style="width:240px; height:75px; background-color:#6bb546; border:0; border-radius:7px; font-size:24px; color:#ffffff; cursor:pointer"></td>
				<td width="20"></td>
				<td align="left"><input onclick="javascript:history.back()" type="button" value="취소" style="width:240px; height:75px; background-color:#ababab; border:0; border-radius:7px; font-size:24px; color:#ffffff; cursor:pointer"></td>
			</tr>
		</table>
	</div>
</form>
