	...
	<div class="divWid">
		...
		<table class="table_basic" width="800" height="133" cellpadding="0" cellspacing="0" style="margin-top:0px; background-image:url('images/registerCheck/00join_acceptinfo_03.gif'); background-size:862px; background-repeat:no-repeat">
			<tr>
				...
				<td align="center">
					<div class="div" style="margin-top:0px"><font style="font-size:25px; color:#323232; font-weight:bold">회원정보 수정</font></div>
				</td>
				<td width="128"></td>
			</tr>
		</table>
		...
		<table class="table_basic" width="400" cellpadding="0" cellspacing="0" style="margin-top:15px; border:1px #acacac solid">
			<!-- 이름 -->
			<tr height="60">
				<th align="center">
				이름
				...
				<td align="center">
					<input type="text" style="outline:0; margin-top:5px; margin-bottom:3px; width:300px; height:26px; font-family:'나눔고딕'; font-size:18px; border:0px; text-align:center">
				</td>
			</tr>
			<tr height="1">
				<td align="center"><img src="images/registerCheck/dot.jpg" width="100" height="1"></td>
				<td align="center"><img src="images/registerCheck/dot.jpg" width="280" height="1"></td>
			<tr>
			<!-- 휴대전화번호 -->
			<tr height="60">
				<th align="center">
				...
				<td align="center">
					...
					<input type="text" name="user_phone1" id="user_phone1" style="outline:0; margin-top:5px; margin-bottom:3px; width:100px; height:26px; font-family:'나눔고딕'; font-size:18px; border:0px; text-align:center" size="4"> -
					<input type="text" name="user_phone2" id="user_phone2" style="outline:0; margin-top:5px; margin-bottom:3px; width:80px; height:26px; font-family:'나눔고딕'; font-size:18px; border:0px; text-align:center">
				</td>
			</tr>
		<table class="table_basic" width="400" cellpadding="0" cellspacing="0" style="margin-top:22px; border:1px #acacac solid">
			<!-- 우편번호 -->
			<tr height="60">
				<th align="center">
				우편번호
				...
				<td align="center">
					<input type="text" onclick="zipErr()" name="user_zipcode" id="user_zipcode" style="outline:0; margin-top:5px; margin-bottom:3px; width:300px; height:26px; font-family:'나눔고딕'; background-color:#ffffff; cursor:pointer; font-size:18px; border:0px; text-align:center" readonly>
				</td>
			</tr>
			<tr height="1">
				<td align="center"><img src="images/registerCheck/dot.jpg" width="100" height="1"></td>
			...
			<tr height="60">
				...
				<td align="center">
					<input type="text" name="user_addr" id="user_addr" style="outline:0; margin-top:5px; margin-bottom:3px; background-color:#ffffff; cursor:pointer; width:300px; height:26px; font-family:'나눔고딕'; font-size:18px; border:0px; text-align:center" readonly>
				</td>
			</tr>
			<tr height="1">
				<td align="center"><img src="images/registerCheck/dot.jpg" width="100" height="1"></td>
		...
		<table class="table_basic" cellpadding="0" cellspacing="0" style="margin-top:60px; margin-bottom:80px">
			<tr>
				...
				<td width="20"></td>
				<td align="center"><input id="registerNext" name="registerNext" type="button" value="탈퇴하기" style="width:100px; height:60px; background-color:#ad1a01; border:0; boder-radius:0; font-size:20px; color:#ffffff; font-family:'나눔고딕'; cursor:pointer"></td>
				<td width="20"></td>
