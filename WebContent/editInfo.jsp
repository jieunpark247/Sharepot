...
<div id="container" class="div container" align="center">
	...
	<jsp:include page="mypageHead.jsp"></jsp:include>
		...
		<a id="check"></a>
		<font style="font-size:22px; color:#414141; font-weight:bold">* 정보 수정 *</font><br><div style="margin-bottom:2px"></div>
		...
		<table class="table_basic" width="500" cellpadding="0" cellspacing="0" style="margin-top:15px; border:1px #acacac solid">
			...
			<tr height="60">
				<td align="center">
					<input type="text" class="regiPrimeInput" name="user_id" placeholder="아이디" id="user_id" style="outline:0; margin-top:5px; margin-bottom:3px; width:480px; height:26px; font-family:'나눔고딕'; font-size:18px; border:0px; text-align:center" value="${mem.member_id }" readonly>
		...
		<table class="table_basic" width="500" cellpadding="0" cellspacing="0" style="margin-top:22px; border:1px #acacac solid">
			...
			<tr height="60">
				<td align="center">
					<input type="text" placeholder="이름" name="user_name" id="user_name" style="outline:0; margin-top:5px; margin-bottom:3px; width:480px; height:26px; font-family:'나눔고딕'; font-size:18px; border:0px; text-align:center" value="${mem.name }">
			...
			<tr height="60">
				<td align="center">
					...
					<input type="text" placeholder="휴대전화" name="user_phone1" id="user_phone1" style="outline:0; margin-top:5px; margin-bottom:3px; width:100px; height:26px; font-family:'나눔고딕'; font-size:18px; border:0px; text-align:center" size="4" value="${phone1 }"> -
					<input type="text" name="user_phone2" id="user_phone2" style="outline:0; margin-top:5px; margin-bottom:3px; width:80px; height:26px; font-family:'나눔고딕'; font-size:18px; border:0px; text-align:center" value="${phone2 }">
		...
		<table class="table_basic" width="500" cellpadding="0" cellspacing="0" style="margin-top:22px; border:1px #acacac solid">
			...
			<tr height="60">
				<td align="center">
					...
					<div id="addrMsg" class="error" style="display:none; margin-bottom:7px">
						<a name="check_addr" style="font-size:13px; color:red">주소를 입력하세요</a>
					</div>
				</td>
			</tr>
		</table>
