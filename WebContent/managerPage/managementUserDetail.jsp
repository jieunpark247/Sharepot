						...
						<div class="panel">
							<div class="panel-body">
								<div class="profile-info">
									...
									<p class="text-uppercase color-info">
										ID :
										${userdto.member_id }</p>
									...
									<ul class="profile-menu list-unstyled">
										...
										<li><a href="#"><i class="ion-ios-settings"></i> ${userdto.member_id }</a></li>
								...
								<div class="profile-states">
									<div class="row">
										...
										<c:forEach items="${rentlist}" var="rentlist">
											...
											<h1><c:out value="${sumReturn}"/></h1>
											<h4>반납한 횟수</h4>
										</div>
										<div class="col-md-4 col-sm-4 col-xs-6">
											<h1><c:out value="${sumOverdue}"/></h1>
											<h4>대여중인 물품수</h4>
										</div>
										<div class="col-md-4 col-sm-4 col-xs-6">
											<h1><c:out value="${sumAll}"/></h1>
											<h4>총 빌린 이력</h4>
										</div>
											...
											<!-- 상세정보 -->
												<div role="tabpanel" class="tab-pane" id="settings">
													<form class="form-horizontal">
														...
														<div class="form-group">
															<label for="pname" class="col-sm-3 control-label">이름</label>
															<div class="col-sm-7">
														...
														<div class="form-group">
															<label for="position" class="col-sm-3 control-label">전화번호</label>
															<div class="col-sm-7">
														...
														<div class="form-group">
															<label for="about" class="col-sm-3 control-label">이메일
																사항</label>
															<div class="col-sm-7">
														...
														<h4>Info</h4>
														<div class="form-group">
															<label for="address" class="col-sm-3 control-label">생일
																주소</label>
															<div class="col-sm-7">
														...
														<div class="form-group">
															<label for="city" class="col-sm-3 control-label">등록날짜</label>
															<div class="col-sm-7">
														...
														<div class="form-group">
															<label for="skills" class="col-sm-3 control-label">이메일
																체크여부</label>
															<div class="col-sm-7">
														...
														<div class="form-group">
															...
															<label for="skills" class="col-sm-3 control-label">프로필
																사진</label>
															<div class="col-sm-7">
								...
								<div class="panel">
									...
									<div class="panel-body">
										...
										<%-- 		<c:forEach items="${rentlist}" var="rentlist">				
											...
											<c:if test="${rentlist.state  eq  1}">
											${rentlist.item_name }
												<small class="stream-time color-success">연체료 :${rentlist.fee }원</small>
														<h5>
															<strong>${rentlist.item_name }</strong>을(를)반납하였습니다.
														</h5>
														<small>${rentlist.return_date }</small>
														<div>
															<a class="btn btn-xs btn-default"><i class="ion-eye"></i>
																물품 상태</a> <a class="btn btn-xs btn-success"><i
