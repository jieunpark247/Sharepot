...
<body style="font-family: '나눔고딕'" onload="$('#log_user_id').focus()">
   ...
   <font style="font-size:22px; color:#414141; font-weight:bold; color: #d55454">* 비밀번호 재확인*</font><br><div style="margin-bottom:2px"></div>
   <div style="padding-top:10px; padding-bottom:10px"><font style="font-size:14px; color:#acacac">본인 확인을 위해 한번 더 비밀번호를 입력해 주세요.<br> 비밀번호는 타인에게 노출되지 않도록 주의해 주세요.</font></div>
   ...
   <table class="table_basic" cellpadding="0" cellspacing="0" style="margin-top:60px; margin-bottom:80px">
      <tr>
         <td align="center"><input id="pwCheck_btn" name="registerNext" type="button" value="확인" style="width:240px; height:75px; background-color:#d55454; border:0; boder-radius:0; font-size:24px; color:#ffffff; font-family:'나눔고딕'; cursor:pointer"></td>
      </tr>
   </table>
   </form>
