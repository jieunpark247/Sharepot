	...
	<div id="container" class="div container" align="center" style="padding-top:67px">
		<div class="divWid">
			...
			<table class="table_basic" cellpadding="0" cellspacing="0" style="margin-top:60px; margin-bottom:80px">
				<tr>
					<td align="right"><input id="registerNext" name="registerNext" type="button" value="회원가입" style="width:240px; height:75px; background-color:#d55454; border:0; font-size:24px; color:#ffffff; cursor:pointer"></td>
					<td width="20"></td>
					<td align="left"><input onclick="javascript:history.back()" type="button" value="이전으로" style="width:240px; height:75px; background-color:#ababab; border:0; font-size:24px; color:#ffffff; cursor:pointer"></td>
				</tr>
			</table>
		</div>
