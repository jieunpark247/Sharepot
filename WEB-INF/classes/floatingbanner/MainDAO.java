...
public class MainDAO {
   ...
   public static MainDTO dustView() {
      ...
      for (int i = 0; i <= 6; i++) {
         ...
         weather_clock_array_value[i] = time.format(today);
